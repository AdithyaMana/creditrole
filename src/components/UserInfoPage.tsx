...
const countries = [
    'United States', 'India', 'China', 'United Kingdom', 'Germany', 'Canada', 
    'Australia', 'Brazil', 'Japan', 'South Korea', 'Other'
];
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Help us choose the most intuitive icons for scientific contributions</p>
            </div>
            <div style={{ width: '80px' }}></div>
          </div>
        </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-2xl p-10 border border-slate-200">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-extrabold text-slate-800 mb-2 tracking-tight">Tell Us About Yourself</h2>
